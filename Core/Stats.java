...
public class Stats {
    ...
    public Stats(int health, int mana, int energy, Damage damage, Resistance resistance, Accuracy accuracy, Critical critical, CriticalBlock criticalBlock, Pierce pierce, int stunResistance, int incomingHeal, int outgoingHeal, int powerPipRating, int shadowPipRating) {
        this.health = health; 
        this.mana = mana;
        this.energy = energy;
        this.damage = damage;
